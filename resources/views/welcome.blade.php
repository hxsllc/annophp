...
<html lang="en">
    <head>
        ...
        <title>mirador-annotations-extend-plugin 0.5.0 Demo</title>
        <link href="demo.7eacd1f5.css" rel="stylesheet" />
    </head>
    <body>
        <div id="demo"></div>
        <script>
                    ...
                    if (0 !== t)
                        if (t) r.push(t[2]);
                            ...
                            (i.charset = "utf-8"),
                                ...
                                (i.src = (function (e) {
                                    return a.p + "" + ({}[e] || e) + "." + { 2: "c367544c", 3: "20a56bbd", 4: "014b0e38", 5: "c4ae33ff", 6: "0be4dbd3", 7: "323a1c17", 8: "3535481c" }[e] + ".js";
                                })(e));
                            var c = new Error();
                            u = function (r) {
        ...
        <script src="demo.1566f689.js"></script>
    </body>
</html>
